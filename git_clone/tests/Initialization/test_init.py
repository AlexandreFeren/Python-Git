...
import os,stat, git_clone.text_colors as color
import shutil, io, contextlib
import subprocess

# makes repo_test/ to perform tests and ensure that testing is safe.
class TestInit(unittest.TestCase):
    ...
    def check_stdout(self,stdout,expected):
        ...
        print(color.b_colors.WARNING,(stdout,expected),color.b_colors.END_C)
    ...
    def make_test_folder(self):
        os.mkdir(os.getcwd()+"\\repo_test")
    
    def empty_dir(self):
        '''
        confirm that target folder(s) is/are empty
        '''
        print(os.getcwd()+"\\repo_test")
        self.assertTrue(os.listdir(os.getcwd()+"\\repo_test") == [])
    ...
    def test_a_():
        print(color.b_colors.WARNING,"test",color.b_colors.END_C)
        return
    def test_init(self):
    ...
    def test_outside(self):
        """
        run subprocess outside of the repository
        """
        while init.is_git_dir(os.getcwd()):
            print("in git dir")
            os.chdir("../")
        print(os.getcwd())
